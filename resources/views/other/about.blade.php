<x-dashboard-layout>
  ...
  <div class="grid gap-6">
    <x-ui.card>
      ...
      <div class="grid gap-4 text-sm leading-relaxed text-base-600">
        <p>
    ...
    <x-ui.card>
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-sm text-left">
          <thead class="bg-base-50">
            <tr>
              <th class="p-3 px-4 font-medium">Code</th>
              <th class="p-3 px-4 font-medium">Criterion</th>
              <th class="p-3 px-4 font-medium">Type</th>
              <th class="p-3 px-4 font-medium">Weight</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-base-200">
            <tr>
              <td class="p-3 px-4">C1</td>
              <td class="p-3 px-4">Population density (jiwa/km&sup2;)</td>
              <td class="p-3 px-4"><span class="px-2 py-1 text-xs font-medium text-green-700 bg-green-100 rounded-full">Benefit</span></td>
              <td class="p-3 px-4">15%</td>
            </tr>
            <tr>
              <td class="p-3 px-4">C2</td>
              <td class="p-3 px-4">Number of JSS Wi-Fi users</td>
              <td class="p-3 px-4"><span class="px-2 py-1 text-xs font-medium text-green-700 bg-green-100 rounded-full">Benefit</span></td>
              <td class="p-3 px-4">25%</td>
            </tr>
            <tr>
              <td class="p-3 px-4">C3</td>
              <td class="p-3 px-4">Number of active JSS Wi-Fi access points</td>
              <td class="p-3 px-4"><span class="px-2 py-1 text-xs font-medium text-yellow-700 bg-yellow-100 rounded-full">Cost</span></td>
              <td class="p-3 px-4">35%</td>
            </tr>
            <tr>
              <td class="p-3 px-4">C4</td>
              <td class="p-3 px-4">Community self-funding (swadaya)</td>
              <td class="p-3 px-4"><span class="px-2 py-1 text-xs font-medium text-yellow-700 bg-yellow-100 rounded-full">Cost</span></td>
              <td class="p-3 px-4">25%</td>
            </tr>
          </tbody>
      ...
      <div class="mt-4 text-sm leading-relaxed text-base-600">
        <p>Benefit criteria reward kemantren with higher values. Cost criteria reward kemantren with lower values — a kemantren with fewer existing access points or less collected funding is considered more in need of support.</p>
        <p class="mt-2">The weights assigned to each criterion are fully editable from the Metrics page, allowing you to adjust priorities based on current policy or budget considerations.</p>
      </div>
    </x-ui.card>
    ...
    <x-ui.card>
      ...
      <ul class="grid gap-2 text-sm list-disc list-inside text-base-600">
        ...
        <li>Satu Data Indonesia — <a href="https://data.go.id" target="_blank" class="text-primary-500 hover:underline">data.go.id</a></li>
      </ul>
    </x-ui.card>
